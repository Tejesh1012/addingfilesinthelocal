...
console.log("hi is this the vscode that we are working on the branches in the dev and test environment so that we have to make that quickly to the deploymennt and the function testing and qa testing in the local environment and the governor took the place in the distribution and having the second thought of going to the variable and constanting the local functions, keep in the resort having the best place to kill the bug")